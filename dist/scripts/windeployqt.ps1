...
$multimediaPluginDir = $qtVersion -ge [version]'6.0' ? "bin\multimedia" : "bin\mediaservice"
if (-not (Test-Path $multimediaPluginDir)) {
    throw "Qt Multimedia deployment is incomplete: $multimediaPluginDir was not created"
}
